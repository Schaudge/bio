...
`,
	...
	sort := testutil.GoExecutable(t, "//go/src/github.com/Schaudge/grailbio/cmd/bio-bam-sort/bio-bam-sort")
	pamtool := testutil.GoExecutable(t, "//go/src/github.com/Schaudge/grailbio/cmd/bio-pamtool/bio-pamtool")

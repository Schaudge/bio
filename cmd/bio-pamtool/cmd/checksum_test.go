...
func TestVerify(t *testing.T) {
	...
	defer sh.Cleanup()
	pamtoolPath := testutil.GoExecutable(t, "//go/src/github.com/Schaudge/grailbio/cmd/bio-pamtool/bio-pamtool")
	dir := sh.MakeTempDir()
	...
	bam2Path := testutil.GetFilePath("//go/src/grail.com/bio/encoding/bam/testdata/test.bam")
